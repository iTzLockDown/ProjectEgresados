...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <h2 class="page-title">EDITAR EL EGRESADO : {{$egresado->nombre}} </h2>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    {!!Form::model($egresado,['route'=>['egresado.update', $egresado->id],'files' => true,'method'=>'PUT','role'=>'form','enctype'=>'multipart/form-data', 'class'=>'form-horizontal'])!!}
